...
def model_selection(name):
    if name == "convnext":
        ...
        model = torch.load("pretrained_models/NRP.pth")

    elif name == "DiffPure":
        model = torch.load("pretrained_models/256x256_diffusion_uncond.pt")
...
def model_transfer(clean_img, adv_img, label, res, save_path=r"C:\Users\PC\Desktop\output", fid_path=None, args=None):
    ...
    if args.dataset_name == "imagenet_compatible":
        models_transfer_name = [
            "resnet", "vgg", "mobile", "inception", "convnext", "vit", "swin",
                  'deit-b', 'deit-s',
...
# fid_score = fid_metric('/home/hanshaojie/anaconda3/envs/FOUAttack/DiffAttack-main/result/ImageNet/diff=0.3/', '/home/hanshaojie/anaconda3/envs/FOUAttack/DiffAttack-main/dataset/imagenet-compatible/images/')
# print("fid", fid_score)
